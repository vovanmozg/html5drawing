  ...
  this.step = function step(grid) {
    ...
    for (let x = 0; x < this.matrix.cells.length; x++) {
      for (let y = 0; y < this.matrix.cells[x].length; y++) {
        ...
        const radius1 = Math.sin((k % 360) / 100) * 1000;
        if ((x - 80) ** 2 + (y - 50) ** 2 < radius1) {
          cell.r = 100;
          if ((x & y) % 4 == (k / 10 + x ^ y) % 3) {
            cell.r = 200;
          }
        ...
        const radius2 = Math.sin(((k + 120) % 360) / 100) * 1000;
        if ((x - 80) ** 2 + (y - 50) ** 2 < radius2) {
          cell.g = 100;
          if (4 & x * y - (k / 10) & 4) {
            cell.g = 150;
          }
        ...
        const radius3 = Math.sin(((k + 240) % 360) / 100) * 1000;
        if ((x - 80) ** 2 + (y - 50) ** 2 < radius3) {
          cell.b = 100;
          if ((x + y) % 2) {
            cell.b = 150;
          }
